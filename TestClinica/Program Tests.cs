...
namespace TestClinica
{
    public class ProgramTests
    {
        ...
        public void TestMarcarConsultaAMeioDePeriodoDisponibilidade()
        {
            ...
            profissionalSaudeTest.ReajustarDisponibilidade(periodoConsulta);
            profissionalSaudeTest.PeriodosDisponibilidade.Should().NotContain(periodoConsulta).And.ContainEquivalentOf(periodoGerado1).And.ContainEquivalentOf(periodoGerado2);
        }
        ...
        public void TestMarcarConsultaNoInicioDePeriodoDisponibilidade()
        {
            ...
            profissionalSaudeTest.ReajustarDisponibilidade(periodoConsulta);
            profissionalSaudeTest.PeriodosDisponibilidade.Should().NotContain(periodoConsulta).And.ContainEquivalentOf(periodoGerado1).And.NotContain(periodoInexistente);
        }
        ...
        public void TestMarcarConsultaParaAQualNaoHaVeterinarioDisponivel()
        {
            ...
            profissionalSaudeTest.PeriodosDisponibilidade.Should().ContainEquivalentOf(periodoGerado1).And.ContainEquivalentOf(periodoGerado2);
        }
